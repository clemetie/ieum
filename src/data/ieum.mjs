export const projects = [
  ...
  },
  {
    ...
    ment: "출판의 무게를 형태로 담다.",
    description:
      "출판사 ‘민음사’의 철학과 자음을 시각적으로 표현한 로고 디자인. 타이포그래피 구조 설계, 컬러 시스템, 사용처에 따른 변형형 로고까지 구성한 브랜드 디자인 프로젝트입니다.",
    image: "/images/minumcover.png", // 대표 이미지
    ...
    roles: [
      ...
      "자음 요소를 활용한 한글/영문 조합 로고 디자인",
      "사용처별 메인형/포인트형/굿즈형 로고 제작",
      "컬러 시스템 및 웹/오프라인 적용 가이드 기획",
    ],
    maincolor: "#754C24",
  },
];
